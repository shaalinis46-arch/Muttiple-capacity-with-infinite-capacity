...
## Output :
```
Enter the mean inter arrival time of objects from Feeder (in secs): 9
Enter the mean  inter service time of Lathe Machine (in secs) :  8
Enter the Additional time taken for the Robot (in secs) :  7
Number of service centre :  6
--------------------------------------------------------------
Multiple Server with Infinite Capacity - (M/M/c):(oo/FIFO)
--------------------------------------------------------------
The mean arrival rate per second : 0.11
...
Average waiting time of an object in the system : 15.03 secs
Average waiting time of an object in the conveyor : 0.03 secs
Probability that the system is busy : 0.28
Probability that the system is empty : 0.72
--------------------------------------------------------------
```
## Result : 
